 ...
 * @author USER
 */
public class Mensal  extends AluguelDoImovel { // declarando que a classe tem herança
    protected Pessoa cpf; //declarando as variaveis da classe
    protected Imovel modelo;

    public Mensal() { //construtor padrão
    }

    public Mensal(Pessoa cpf, Imovel modelo, String tipo, String contratante) { 
